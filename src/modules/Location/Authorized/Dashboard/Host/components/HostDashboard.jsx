            ...
            <div className="room-status">
                <div className="room-features">
                    ...
                    <div className="d-flex">
                        <Form.Group
                            md="9"
                            className="mb-3 flex-together label-room"
                            controlId="exampleForm.ControlInput1"
                        >
                            <Form.Label className="label">
                                <b>From</b>
        ...
        <>
            {isAlert && (
                <Alert key={"success"} variant={"success"}>
                    Successfully Announcement Posted
                </Alert>
            )}
                        ...
                        <div className="announcement-by">
                            <div className="announcement-threads">
                                <div>
                                    ...
                                    <div>
                                        meeting at room red today! Everyone
                                        please be there.
                                    </div>
                                </div>
                            </div>
                           {announcementMade && <div className="announcement-threads">
                                <div>
                                    <div className="avatar-for-threads">
                                        <div className="avatar threads-avatar">
                                            <div className="arrow threads-arrow">
                                    ...
                                    <div>Please be on time everyone.</div>
                                </div>
                            </div>}
                        </div>
                    </div>
                    ...
                    <div className="room-status meeting-room-booked">
                        ...
                        <div className="room-features">
                            ...
                            <div className="d-flex">
                                <Form.Group
                                    md="9"
                                    className="mb-3 d-flex flex-together label-room"
                                    controlId="exampleForm.ControlInput1"
                                >
                                    <Form.Label className="label">
                                        <b>From</b>

...
const Manage = () => {
  ...
  <Form.Label style={{textAlign: "center", marginRight: "16px"}} className='label'><b>Room Name</b></Form.Label>
...
<tbody>
  ...
  <ConfirmationModal data={data} show={show} onHide={handleClose} content={modalContent} btnVariant={variant} />
  </div>
  )
}

        ...
        if (value === "No") {
            const denyAttendanceContent = (
                ...
                >
                    ...
                    >
                        <b>
                            Why will you not be attending?
                            <span>(In 150 words)</span>
                        </b>
                    </Form.Label>
                ...
                <div className="announcement-by">
                    <div className="announcement-threads">
                        <div>
                            ...
                            <div>
                                Meeting at room Red today! Please be there
                                everyone.
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <Table striped bordered hover size="sm">
                        ...
                        <tbody>
                            <tr style={{ textAlign: "center" }}>
                                <td>Red</td>
                                <td style={{ maxWidth: "20px !important" }}>
                                ...
                                <td>
                                    <Form.Select
                                        onChange={(event) =>
                                            attendanceDenied(event.target.value)
                                        }
                                    >
